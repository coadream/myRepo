...
public class LoggerAspect {
	...
	public Object timeCheckAround(ProceedingJoinPoint jp) throws Throwable{
		try{
			//before
			long start = System.currentTimeMillis();//1970.01.01 00:00:00.000 ~ 실행시간까지를 밀리초로 리턴
			long start2 = System.nanoTime();//~실행시간까지를 나노초로 리턴
